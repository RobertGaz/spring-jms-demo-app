...
import com.mdrsolutions.SpringJmsExample.service.BookOrderService;
...
public class AppController {
    ...
    public @ResponseBody String processOrder(@PathVariable("storeId") String storeId,
        ...
        try {
            ...
            bookOrderService.send(build(customerId, bookId, orderId), storeId);
