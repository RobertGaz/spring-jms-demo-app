...
import com.mdrsolutions.SpringJmsExample.model.Book;
import com.mdrsolutions.SpringJmsExample.model.BookOrder;
import com.mdrsolutions.SpringJmsExample.model.Customer;
import com.mdrsolutions.SpringJmsExample.service.BookOrderSender;
...
public class AppController {
    ...
    @Autowired
    private BookOrderSender bookOrderSender;
    ...
    public @ResponseBody String processOrder(@PathVariable("storeId") String storeId,
        ...
        try {
            ...
            bookOrderSender.send(build(customerId, bookId, orderId), storeId);
